#!/usr/bin/env python3
"""Print every skill's full description and its word counts against project-skill's budget.
...
Usage:
    python3 .agents/skills/project-skill/scripts/skill_stats.py [--repo-root <path>] [name ...]
"""
